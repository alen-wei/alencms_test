...
<head>
    ...
    <style>
		...
		.copyright small{ color:#ccc; display: inline-block; float: right;}
...
<body>
    ...
    <div class="copyright">
        <a title="官方网站" href="<?php echo ALENCMS_URL; ?>">AlenCMS</a> 
        <span>V<?php echo ALENCMS_VERSION; ?></span> 
        <small>内核版本 ThinkPHP V<?php echo THINK_VERSION; ?></small> 
    </div>
    <?php if(\think\App::$debug) { ?>
    <script>
